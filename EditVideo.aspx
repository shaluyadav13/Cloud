<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditVideo.aspx.cs" Inherits="EditVideo" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="body2">
        ...
        <div>
            ...
            <p>
                You can edit the basic information for your video below. When you are finished,
        ...
        <li><span class="formLabel">Transcript File</span>
            <asp:FileUpload ID="FileUpload2" runat="server" />
                ...
                <br />
                <li><span class="formLabel">&nbsp;</span>
                    <asp:Button ID="removeVideoButton" runat="server" Text="Remove Video" CausesValidation="False"
                        OnClientClick="javascript:return confirm('Are you sure you want to delete this video? Click OK to delete.');"
                        OnClick="removeVideoButton_Click" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnClaim" runat="server" Text="Claim Video" Visible="false"
