<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="EditFile.aspx.cs" Inherits="EditFile" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="body2">
        ...
        <div>
            ...
            <p>
                You can edit the basic information for your file below. When you are finished,
                ...
                <div class="copyright">
                    ...
                    <li>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="studentGroupListBox"
                            ErrorMessage="Please select which group to post your document to.">  
        ...
        <li><span class="formLabel">Transcript File</span>
            <asp:FileUpload ID="FileUpload2" runat="server" />
                ...
                <br />
                <li><span class="formLabel">&nbsp;</span>
                    <asp:Button ID="removeVideoButton" runat="server" Text="Remove File" CausesValidation="False"
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnClaim" runat="server" Text="Claim Document" Visible="false"
