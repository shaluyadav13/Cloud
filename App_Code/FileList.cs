...
{
    /// <summary>
    /// This is a custom web control designed to display files in an orderly manner. It does several things.
    /// 
    /// The main feature is rendering the files into a nice list.
    ...
    /// </summary>
    public class FileList : WebControl
    {
        ...
        public FileList()
        {
            ...
            ItemsPerPage = 10;
            listItems = new List<FileListItem>();
            EnablePaging = true;
            EnableSorting = true;
            SelectedPage = 1;
            PageDisplayCount = 10;
        ...
        {
            IEnumerable<FileListItem> items = listItems;
            ...
            // Render the videos.
            writer.WriteLine("<ul id=\"fileList\">");
        ...
        /// <summary>
        /// Sets a collection of files to be the data source for this File list.
        /// </summary>
        public IEnumerable<Files> Files
        {
            set
            {
                var items = listItems;
                items.Clear();
                items.AddRange(value.Select(i => new FileListItem(i, DisplayAudioOwner, IncludeGroupIDInURL)));
                listItems = items;
        ...
        {
            get { return (List<FileListItem>)ViewState["listItems"]; }
        ...
        private class FileListItem
        {
            ...
            public FileListItem(Files fid, bool displayPostedBy, bool includeGroupIDInURL)
            {
                title = fid.Title;

                description = fid.Description.Replace("\n", "<br />");
                fileID = fid.FileID;
                numOfHits = fid.Views;
                datePosted = fid.DatePosted;
                Username = fid.Username;
                this.includeGroupIDInURL = includeGroupIDInURL;
                //Uploadedby = vid.UploadedBy;
              //  copyRight = fid.Copyright;
                if (fid.GroupID != null)
                {
                    groupId = fid.GroupID;
                }
            ...
            public void Render(HtmlTextWriter writer)
            {
                ...
                {
                    string file = server.MapPath("documents\\") + fileID + fileFormats[i];
                ...
                //{
                    ...
                    {
                        writer.WriteLine("<a href=\"OpenFile.aspx?groupID={0}&fid={1}\"><img class=\"listThumbnail\" src=\"/images/largeIcons/fileIconLarge.png\"/></a>", groupId, fileID);
                        writer.WriteLine("<p>");

                        writer.WriteLine(String.Format("<a href=\"OpenFile.aspx?groupID=" + groupId + "&" + "fid={0}\">{1}</a> - {2} ({3} view{4})",
                            fileID,
                            title,
                    ...
                    {
                        writer.WriteLine("<a href=\"OpenFile.aspx?fid={0}\"><img class=\"listThumbnail\" src=\"/images/largeIcons/fileIconLarge.png\"/></a>", fileID);
                        writer.WriteLine("<p>");

                        writer.WriteLine(String.Format("<a href=\"OpenFile.aspx?fid={0}\">{1}</a> - {2} ({3} view{4})",
                            fileID,
                            title,
                            datePosted.ToShortDateString(),
                            numOfHits,
                ...
                if (fileConverted)
                {
                    ...
                    // student can edit thier files only. 'Edit' link is visible only to the faculty.
                    ...
                    {
                        writer.WriteLine(String.Format("<br /><a href=\"EditFile.aspx?fid={0}\">Edit</a>",
                                             fileID));
                    }
                }
                else
