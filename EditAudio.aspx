<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditAudio.aspx.cs" Inherits="EditAudio" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="body2">
        ...
        <div>
            ...
            <p>
                You can edit the basic information for your audio below. When you are finished,
        ...
        you do not want to keep any changes.
            ...
            <ul class="formList">
                ...
                <div class="copyright">
                    ...
                    <li>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="studentGroupListBox"
                            ErrorMessage="Please select which group to post your audio to.">  
                ...
                <li>
                    <span class="replaceFileLabel">Replace Transcript</span>&nbsp;&nbsp;
                    <asp:FileUpload ID="transcript" runat="server" title="Test" Width="183px" />
                    <br />
                    <br />
                    <br />
                </li>
        ...
        <li><span class="formLabel">Transcript File</span>
            <asp:FileUpload ID="FileUpload2" runat="server" />
                ...
                <br />
                <li><span class="formLabel">&nbsp;</span>
                    <asp:Button ID="removeVideoButton" runat="server" Text="Remove Audio" CausesValidation="False"
                        OnClientClick="javascript:return confirm('Are you sure you want to delete this audio? Click OK to delete.');"
                        OnClick="removeAudioButton_Click" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnClaim" runat="server" Text="Claim Audio" Visible="false"
