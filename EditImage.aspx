<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditImage.aspx.cs" Inherits="EditImage" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="body2">
        ...
        <div>
            ...
            <p>
                You can edit the basic information for your image below. When you are finished,
        ...
        you do not want to keep any changes.
            ...
            <ul class="formList">
                        ...
                        <asp:RadioButton ID="rbtn2" runat="server" AutoPostBack="true" Text="NO" 
                            ...
                            <div style="margin-left: -39px">
                                <li><span class="formLabel">Title</span> &emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ClientIDMode="Static" runat="server" ControlToValidate="titleTextBox"
                ...
                <li><span class="formLabel">Description</span> &emsp;&emsp;&emsp;<div class="uploadTextShowMobile">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ClientIDMode="Static" runat="server" ControlToValidate="descriptionTextBox"
                ...
                <div class="copyright">
                    ...
                    <li>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ClientIDMode="Static" runat="server" ControlToValidate="studentGroupListBox"
                            ErrorMessage="Please select which group to post your image to.">  
        ...
        <li><span class="formLabel">Transcript File</span>
            <asp:FileUpload ID="FileUpload2" runat="server" />
                ...
                <li><span class="formLabel">&nbsp;</span>
                    <asp:Button ID="cancelButton" runat="server" Text="Cancel" ClientIDMode="Static" CausesValidation="False"
                    ...
                    <asp:Button ID="submitButton" runat="server" Text="Submit" ClientIDMode="Static" OnClick="submitButton_Click" />
                </li>
                <br />
                <br />
                <li><span class="formLabel">&nbsp;</span>
                    <asp:Button ID="removeVideoButton" runat="server" Text="Delete Image" ClientIDMode="Static" CausesValidation="False"
                        OnClientClick="javascript:return confirm('Are you sure you want to delete this file? Click OK to delete.');"
                        OnClick="removeFileButton_Click" />




                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnClaim" runat="server" Text="Claim Image" Visible="false"
