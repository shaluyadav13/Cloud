<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminWebSearch.aspx.cs" Inherits="adminWebSearch" MasterPageFile="~/MasterPage.master" %>
...
<asp:content id="Content1" contentplaceholderid="ContentPlaceHolder1" runat="Server">
                <div id="body2">
                    <br />
                    <p>
                        To search all Websites within Northwest Cloud, enter some search terms.
        Title, description, and username will be searched.
                    ...
                    <div>
                        ...
                        <local:WebSiteList ID="webList" runat="server" EnablePaging="true" EnableSorting="false" DisplayVideoOwner="True" ItemsPerPage="10" PageDisplayCount="10" SelectedPage="1" />
                    </div>
                </div>
    </asp:content>