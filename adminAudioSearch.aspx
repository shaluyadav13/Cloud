<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminAudioSearch.aspx.cs" Inherits="adminAudioSearch" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="body2">
        <br />
        <p>
            To search all Audios within Northwest Cloud, enter some search terms.
        ...
        <div>
            ...
            <local:AudioList ID="audioList" runat="server" EnablePaging="true" EnableSorting="false" DisplayVideoOwner="True" ItemsPerPage="10" PageDisplayCount="10" SelectedPage="1" />
        </div>
    </div>
</asp:Content>
